...
export async function Admin(ctcTop, interact) {
  ...
  const v270 = stdlib.protect(ctc3, await interact.setParam(), {
    at: './index.rsh:44:37:application',
  ...
  const v282 = stdlib.ge(v274, stdlib.checkedBigNumberify('./index.rsh:46:23:decimal', stdlib.UInt_max, '0'));
  stdlib.assert(v282, {
  ...
  const v283 = stdlib.le(v274, stdlib.checkedBigNumberify('./index.rsh:47:23:decimal', stdlib.UInt_max, '10000'));
  stdlib.assert(v283, {
    at: './index.rsh:47:11:application',
    fs: ['at ./index.rsh:37:13:application call to [unknown function] (defined at: ./index.rsh:37:17:function exp)'],
    msg: null,
    who: 'Admin'
    });
  ...
  const v297 = stdlib.ge(v285, stdlib.checkedBigNumberify('./index.rsh:57:22:decimal', stdlib.UInt_max, '0'));
  stdlib.assert(v297, {
  ...
  const v298 = stdlib.le(v285, stdlib.checkedBigNumberify('./index.rsh:58:22:decimal', stdlib.UInt_max, '10000'));
  stdlib.assert(v298, {
  ...
  while (await (async () => {
    ...
    switch (v370[0]) {
      ...
      case 'AdminAPI_updateParam0_66': {
        ...
        ;
        ;
        const v470 = v432[stdlib.checkedBigNumberify('./index.rsh:79:11:spread', stdlib.UInt_max, '0')];
        const v471 = v432[stdlib.checkedBigNumberify('./index.rsh:79:11:spread', stdlib.UInt_max, '1')];
        const v472 = v432[stdlib.checkedBigNumberify('./index.rsh:79:11:spread', stdlib.UInt_max, '2')];
        const v473 = v432[stdlib.checkedBigNumberify('./index.rsh:79:11:spread', stdlib.UInt_max, '3')];
        const v474 = stdlib.addressEq(v369, v300);
        const v475 = stdlib.ge(v470, stdlib.checkedBigNumberify('./index.rsh:89:26:decimal', stdlib.UInt_max, '0'));
        const v476 = v474 ? v475 : false;
        const v477 = stdlib.le(v470, stdlib.checkedBigNumberify('./index.rsh:90:26:decimal', stdlib.UInt_max, '10000'));
        const v478 = v476 ? v477 : false;
        stdlib.assert(v478, {
          at: './index.rsh:88:18:application',
          fs: ['at ./index.rsh:87:48:application call to [unknown function] (defined at: ./index.rsh:87:48:function exp)'],
          msg: null,
          who: 'Admin'
          });
        const v480 = true;
...
export async function _AdminAPI_getInfo3(ctcTop, interact) {
  ...
  const v313 = stdlib.protect(ctc3, await interact.in(), {
    ...
    fs: ['at ./index.rsh:69:12:application call to [unknown function] (defined at: ./index.rsh:69:12:function exp)', 'at ./index.rsh:61:19:application call to "runAdminAPI_getInfo0_66" (defined at: ./index.rsh:68:11:function exp)', 'at ./index.rsh:61:19:application call to [unknown function] (defined at: ./index.rsh:61:19:function exp)'],
    msg: 'in',
  ...
  const txn1 = await (ctc.sendrecv({
    ...
    onlyIf: true,
    out_tys: [ctc5],
    pay: [stdlib.checkedBigNumberify('./index.rsh:70:16:decimal', stdlib.UInt_max, '0'), [[stdlib.checkedBigNumberify('./index.rsh:70:20:decimal', stdlib.UInt_max, '0'), v286]]],
    sim_p: (async (txn1) => {
      const sim_r = { txns: [], mapRefs: [], maps: [] };
      let sim_txn_ctr = stdlib.UInt_max;
      const getSimTokCtr = () => { sim_txn_ctr = sim_txn_ctr.sub(1); return sim_txn_ctr; };
    ...
    case 'AdminAPI_getInfo0_66': {
      ...
      if (v205) {
        stdlib.protect(ctc6, await interact.out(v373, v400), {
          at: './index.rsh:68:12:application',
          fs: ['at ./index.rsh:68:12:application call to [unknown function] (defined at: ./index.rsh:68:12:function exp)', 'at ./index.rsh:72:16:application call to "mInfo" (defined at: ./index.rsh:71:17:function exp)', 'at ./index.rsh:71:17:application call to [unknown function] (defined at: ./index.rsh:71:17:function exp)'],
          msg: 'out',
          who: 'AdminAPI_getInfo'
          });
        }
...
export async function _AdminAPI_updateParam3(ctcTop, interact) {
  ...
  const v321 = stdlib.protect(ctc3, await interact.in(), {
    at: './index.rsh:1:23:application',
    fs: ['at ./index.rsh:80:45:application call to [unknown function] (defined at: ./index.rsh:80:45:function exp)', 'at ./index.rsh:61:19:application call to "runAdminAPI_updateParam0_66" (defined at: ./index.rsh:79:11:function exp)', 'at ./index.rsh:61:19:application call to [unknown function] (defined at: ./index.rsh:61:19:function exp)'],
    msg: 'in',
  ...
  const v332 = stdlib.ge(v322, stdlib.checkedBigNumberify('./index.rsh:82:26:decimal', stdlib.UInt_max, '0'));
  const v333 = v331 ? v332 : false;
  const v334 = stdlib.le(v322, stdlib.checkedBigNumberify('./index.rsh:83:26:decimal', stdlib.UInt_max, '10000'));
  const v335 = v333 ? v334 : false;
  stdlib.assert(v335, {
    at: './index.rsh:81:17:application',
    fs: ['at ./index.rsh:80:45:application call to [unknown function] (defined at: ./index.rsh:80:45:function exp)', 'at ./index.rsh:80:45:application call to [unknown function] (defined at: ./index.rsh:80:45:function exp)', 'at ./index.rsh:61:19:application call to "runAdminAPI_updateParam0_66" (defined at: ./index.rsh:79:11:function exp)', 'at ./index.rsh:61:19:application call to [unknown function] (defined at: ./index.rsh:61:19:function exp)'],
    msg: null,
    who: 'AdminAPI_updateParam'
    });
  ...
  const txn1 = await (ctc.sendrecv({
    ...
    onlyIf: true,
    out_tys: [ctc5],
    pay: [stdlib.checkedBigNumberify('./index.rsh:86:26:decimal', stdlib.UInt_max, '0'), [[stdlib.checkedBigNumberify('./index.rsh:86:30:decimal', stdlib.UInt_max, '0'), v286]]],
    sim_p: (async (txn1) => {
      const sim_r = { txns: [], mapRefs: [], maps: [] };
      let sim_txn_ctr = stdlib.UInt_max;
      const getSimTokCtr = () => { sim_txn_ctr = sim_txn_ctr.sub(1); return sim_txn_ctr; };
    ...
    case 'AdminAPI_updateParam0_66': {
      ...
      if (v205) {
        stdlib.protect(ctc7, await interact.out(v432, v481), {
          at: './index.rsh:79:12:application',
          fs: ['at ./index.rsh:79:12:application call to [unknown function] (defined at: ./index.rsh:79:12:function exp)', 'at ./index.rsh:92:12:application call to "k" (defined at: ./index.rsh:87:48:function exp)', 'at ./index.rsh:87:48:application call to [unknown function] (defined at: ./index.rsh:87:48:function exp)'],
          msg: 'out',
          who: 'AdminAPI_updateParam'
          });
        }
